/**
 * Serverless-compatible instructions PDF generator.
 *
 * Generates the instructions PDF page with embedded cover image.
 ...
 *
 * Serverless-compatible: no file I/O, returns Uint8Array.
 *
